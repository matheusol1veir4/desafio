...
public abstract class BaseAvaliacaoDetalheResourceImpl
	implements AvaliacaoDetalheResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<AvaliacaoDetalhe> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/avaliacao-headless/v1.0/avaliacoes/{avaliacaoId}/detalhes'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/avaliacoes/{avaliacaoId}/detalhes")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<AvaliacaoDetalhe> getAllAvaliacaoDetalhes(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/avaliacao-headless/v1.0/avaliacoes/{avaliacaoId}/detalhes' -d $'{"avaliacaoId": ___, "desempenho": ___, "nomeAvaliador": ___, "observacoesAvaliador": ___, "tipoAvaliador": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/avaliacao-headless/v1.0/detalhes/{avaliacaoDetalheId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/avaliacao-headless/v1.0/detalhes/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/detalhes/batch")
	...
	public Response deleteAvaliacaoDetalheBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				AvaliacaoDetalhe.class.getName(), callbackURL, object)
		).build();
	}
	...
	public void create(
			Collection<AvaliacaoDetalhe> avaliacaoDetalhes,
	...
	public void delete(
		...
		for (AvaliacaoDetalhe avaliacaoDetalhe : avaliacaoDetalhes) {
			deleteAvaliacaoDetalhe(avaliacaoDetalhe.getAvaliacaoDetalheId());
		}
	}
	...
	@Override
	public Page<AvaliacaoDetalhe> read(
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<AvaliacaoDetalhe>,
			 UnsafeFunction<AvaliacaoDetalhe, AvaliacaoDetalhe, Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<AvaliacaoDetalhe>,
			 UnsafeConsumer<AvaliacaoDetalhe, Exception>, Exception>
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseAvaliacaoDetalheResourceImpl.class);
