...
/**
 * Provides the local service interface for DescricaoDesafio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DescricaoDesafioLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DescricaoDesafioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.example.model.avaliacao.service.impl.DescricaoDesafioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the descricao desafio local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DescricaoDesafioLocalServiceUtil} if injection and service tracking are not available.
	 */
