...
public interface AvaliacaoResource {
	...
	public HttpInvoker.HttpResponse getAvaliacoesPendentesParaMimHttpResponse()
		throws Exception;

	public Object getFuncionarios(String nome, Pagination pagination)
		throws Exception;

	public HttpInvoker.HttpResponse getFuncionariosHttpResponse(
			String nome, Pagination pagination)
		throws Exception;
	...
	public static class AvaliacaoResourceImpl implements AvaliacaoResource {
		...
		public Page<AvaliacaoCompleta> getAvaliacoesPendentesParaMim()
			...
			HttpInvoker.HttpResponse httpResponse =
				getAvaliacoesPendentesParaMimHttpResponse();
			...
			try {
				return Page.of(content, AvaliacaoCompletaSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/avaliacao-headless/v1.0/avaliacoes/pendentes-para-mim");
		...
		public Object getFuncionarios(String nome, Pagination pagination)
			...
			HttpInvoker.HttpResponse httpResponse = getFuncionariosHttpResponse(
				nome, pagination);
		...
		public HttpInvoker.HttpResponse getFuncionariosHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/avaliacao-headless/v1.0/funcionarios");
