...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "API REST para gerenciamento de avaliações de desafio de colaboradores (30, 60 e 90 dias)", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Desafio Avaliacao REST API", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(AvaliacaoResourceImpl.class);

			add(AvaliacaoDetalheResourceImpl.class);
