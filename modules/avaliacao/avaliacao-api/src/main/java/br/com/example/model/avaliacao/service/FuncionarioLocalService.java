...
public interface FuncionarioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>br.com.example.model.avaliacao.service.impl.FuncionarioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the funcionario local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FuncionarioLocalServiceUtil} if injection and service tracking are not available.
	 */
