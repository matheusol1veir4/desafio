...
public class AvaliacaoPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newAvaliacao.setUserName(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingAvaliacao.getUserName(), newAvaliacao.getUserName());
		Assert.assertEquals(
	...
	protected OrderByComparator<Avaliacao> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"avaliacaoId", true, "funcionarioId", true, "dataAvaliacao", true,
			"periodoDesafio", true, "observacoesGerais", true, "areaAtuacao",
			true);
	}
	...
	protected Avaliacao addAvaliacao() throws Exception {
		...
		avaliacao.setUserName(RandomTestUtil.randomString());
