...
public class AvaliacaoDetalheUtil {
	 ...
	 * @return the matching avaliacao detalhes
	 */
	public static List<AvaliacaoDetalhe> findByTipoAvaliadorAndDesempenho(
		int tipoAvaliador, int desempenho) {

		return getPersistence().findByTipoAvaliadorAndDesempenho(
	...
	public static List<AvaliacaoDetalhe> findByTipoAvaliadorAndDesempenho(
		...
		return getPersistence().findByTipoAvaliadorAndDesempenho(
			tipoAvaliador, desempenho, start, end);
	}
	 ...
	 * @throws NoSuchAvaliacaoDetalheException if a matching avaliacao detalhe could not be found
	 */
	public static AvaliacaoDetalhe findByTipoAvaliadorAndDesempenho_First(
			int tipoAvaliador, int desempenho,
			OrderByComparator<AvaliacaoDetalhe> orderByComparator)
		throws br.com.example.model.avaliacao.exception.
			NoSuchAvaliacaoDetalheException {

		return getPersistence().findByTipoAvaliadorAndDesempenho_First(
	 ...
	 * @return the first matching avaliacao detalhe, or <code>null</code> if a matching avaliacao detalhe could not be found
	 */
	public static AvaliacaoDetalhe fetchByTipoAvaliadorAndDesempenho_First(
		int tipoAvaliador, int desempenho,
		OrderByComparator<AvaliacaoDetalhe> orderByComparator) {

		return getPersistence().fetchByTipoAvaliadorAndDesempenho_First(
			tipoAvaliador, desempenho, orderByComparator);
	}
	 ...
	 * @throws NoSuchAvaliacaoDetalheException if a matching avaliacao detalhe could not be found
	 */
	public static AvaliacaoDetalhe findByTipoAvaliadorAndDesempenho_Last(
			int tipoAvaliador, int desempenho,
			OrderByComparator<AvaliacaoDetalhe> orderByComparator)
		throws br.com.example.model.avaliacao.exception.
			NoSuchAvaliacaoDetalheException {

		return getPersistence().findByTipoAvaliadorAndDesempenho_Last(
			tipoAvaliador, desempenho, orderByComparator);
	}
	 ...
	 * @return the last matching avaliacao detalhe, or <code>null</code> if a matching avaliacao detalhe could not be found
	 */
	public static AvaliacaoDetalhe fetchByTipoAvaliadorAndDesempenho_Last(
		int tipoAvaliador, int desempenho,
		OrderByComparator<AvaliacaoDetalhe> orderByComparator) {

		return getPersistence().fetchByTipoAvaliadorAndDesempenho_Last(
			tipoAvaliador, desempenho, orderByComparator);
	}
	 ...
	 * @throws NoSuchAvaliacaoDetalheException if a avaliacao detalhe with the primary key could not be found
	 */
	public static AvaliacaoDetalhe[]
			findByTipoAvaliadorAndDesempenho_PrevAndNext(
				long avaliacaoDetalheId, int tipoAvaliador, int desempenho,
				OrderByComparator<AvaliacaoDetalhe> orderByComparator)
		throws br.com.example.model.avaliacao.exception.
			NoSuchAvaliacaoDetalheException {

		return getPersistence().findByTipoAvaliadorAndDesempenho_PrevAndNext(
			avaliacaoDetalheId, tipoAvaliador, desempenho, orderByComparator);
	}
	 ...
	 * @param desempenho the desempenho
	 */
	public static void removeByTipoAvaliadorAndDesempenho(
		int tipoAvaliador, int desempenho) {

		getPersistence().removeByTipoAvaliadorAndDesempenho(
			tipoAvaliador, desempenho);
	}
	 ...
	 * @return the number of matching avaliacao detalhes
	 */
	public static int countByTipoAvaliadorAndDesempenho(
		int tipoAvaliador, int desempenho) {

		return getPersistence().countByTipoAvaliadorAndDesempenho(
			tipoAvaliador, desempenho);
	}
